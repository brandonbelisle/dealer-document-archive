...
export default function APNavbar({ darkMode, setDarkMode, loggedInUser, page, setPage, setShowChangePassword, setChangePasswordForm, setChangePasswordError, setChangePasswordSuccess, handleLogout, setShowSubscriptionsModal, setAdminSection, onOpenHelpTicket, onShowToast }) {
  ...
  const t = {
    accent: apAccent,
    accentSoft: darkMode ? "rgba(34,197,94,0.15)" : "rgba(34,197,94,0.08)",
  ...
  const apps = [
    ...
    { id: "ap", name: "Accounts Payable", permission: "view_ap", icon: (
      <div style={{ width: 28, height: 28, borderRadius: 7, background: `linear-gradient(135deg,${apAccent},${apAccentDark})`, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontSize: 10, fontWeight: 800 }}>AP</div>
  ...
  return (
    <nav style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        <div onClick={() => setPage("landing")} style={{ display: "flex", alignItems: "center", gap: 9, cursor: "pointer" }}>
          <div style={{
            ...
            height: 28,
            borderRadius: 7,
            background: `linear-gradient(135deg,${apAccent},${apAccentDark})`,
            display: "flex",
            alignItems: "center",
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0, position: "relative", zIndex: 2 }}>
        ...
        <AlertsDropdown darkMode={darkMode} currentUserId={loggedInUser?.id} onShowToast={onShowToast} />
        <div style={{ position: "relative" }}>
          <button
            ...
            style={{
              ...
              padding: "6px 10px",
              cursor: "pointer",
              color: showAppsDropdown ? apAccent : t.textMuted,
              display: "flex",
              alignItems: "center",
              gap: 6,
              fontSize: 13,
            ...
            >
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 4 }}>
                {filteredApps.map((app) => (
                  ...
                  >
                    <div style={{ color: apAccent, display: "flex", alignItems: "center" }}>
                      {app.icon}
                    </div>
                  </div>
                ))}
