...
export const FolderOpenIcon = ({ size = 24 }) =>
  I(
    <>
      <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />
      <path d="M2 10h20" />
...
export const MoonIcon = () =>
  I(<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />, 15);

export const ChevronDown = () =>
  I(<polyline points="6 9 12 15 18 9" />, 14, 2.5);
...
export const WrenchIcon = ({ size = 15 }) =>
  I(
...
export const ShieldIcon = ({ size = 15 }) =>
  I(
...
export const InboxIcon = ({ size = 15 }) =>
  I(
    <>
...
export const AlertTriangleIcon = ({ size = 22 }) =>
  I(
    <>
...
export const BellOffIcon = ({ size = 16 }) =>
  I(
    <>
      <path d="M13.73 21a2 2 0 0 1-3.46 0" />
...
export const XCloseIcon = ({ size = 16 }) =>
  I(
    <>
      <line x1="18" y1="6" x2="6" y2="18" />
      <line x1="6" y1="6" x2="18" y2="18" />
