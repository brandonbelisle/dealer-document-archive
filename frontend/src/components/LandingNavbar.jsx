...
import { SunIcon, MoonIcon, UserIcon, ShieldIcon, GearIcon, LogOutIcon, ChevronDown, BellIcon } from "./Icons";
import AlertsDropdown from "./AlertsDropdown";

export default function LandingNavbar({ darkMode, setDarkMode, loggedInUser, setPage, setShowChangePassword, setChangePasswordForm, setChangePasswordError, setChangePasswordSuccess, handleLogout, setShowSubscriptionsModal }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        {/* Left side - empty or can add logo/title here */}
      </div>
