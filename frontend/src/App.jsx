...
function AppInner() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: t.pageBg, color: t.text, fontFamily: "'Geist','DM Sans',system-ui,sans-serif", transition: "background 0.35s" }}>
      ...
      {page === "folders-browse" && <FoldersBrowsePage locations={locations} departments={departments} folders={folders} deptsInLocation={deptsInLocation} foldersInDepartment={foldersInDepartment} filesInFolder={filesInFolder} allFilesInFolderRecursive={allFilesInFolderRecursive} subfoldersOf={subfoldersOf} setActiveLocation={setActiveLocation} setActiveDepartment={setActiveDepartment} setActiveFolderId={setActiveFolderId} setFolderSearch={setFolderSearch} setSelectedFile={setSelectedFile} setPage={setPage} t={t} darkMode={darkMode} />}
