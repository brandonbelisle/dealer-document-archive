...
export default function AddUserModal({ show, onClose, groups, onUserCreated, t, darkMode }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 style={{ fontSize: 16, fontWeight: 600, margin: 0 }}>Add New User</h2>
          <button
            onClick={onClose}
            style={{
        ...
        <form onSubmit={handleSubmit} style={{ padding: "20px" }}>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <div style={{ fontSize: 11, color: t.textDim, marginTop: 4 }}>
              16 characters, includes uppercase, lowercase, numbers, and symbols
            </div>
          </div>
